...
const MealTracker: React.FC = () => {
  ...
  const { data: searchResults, isLoading: searchLoading } = useSearchFood(searchQuery);
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {searchQuery.length > 0 && searchResults?.data && (
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <div className="flex items-center gap-1">
                                      <span>{calculateTotals().calories} calories</span>
              ...
              <CardContent>
                {logsLoading ? (
                  ...
                  <div className="space-y-6">
                    {Object.entries(
                      mealLogsData.data.reduce((acc: Record<string, any[]>, meal: MealLog) => {
